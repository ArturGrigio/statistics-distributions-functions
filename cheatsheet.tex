     ...
     \addtolength{\linewidth}{-2\fboxsep}%
      \addtolength{\linewidth}{-2\fboxrule}%
       \begin{minipage}{\linewidth}
            ...
            \end{equation}
            \text{So it does not fall within percentile if $x_Q < q_0.975$}
        \end{minipage}
}
     ...
     \addtolength{\linewidth}{-2\fboxsep}%
      \addtolength{\linewidth}{-2\fboxrule}%
       \begin{minipage}{\linewidth}
            ...
            \begin{equation}
                {P}(950 \leq X \leq 1050) = P(\frac{950 - 1000}{25} \leq Z \leq \frac{1050 - 1000}{25}) = P(-2 \leq Z \leq 2) = P(-2 \leq Z) \times P(Z \leq 2) = .97725 \times .97725 \approx .95
            \end{equation}
...
\section{Lifetimes; $X \sim Exponential(\lambda_X=1000), Y \sim Exponential(\lambda_X=1200)$ }
\fbox{
    \addtolength{\linewidth}{-2\fboxsep}%
    \addtolength{\linewidth}{-2\fboxrule}%
    \begin{minipage}{\linewidth}
